...
var section__calculator = new Vue({
		...
		computed: {
				initialFee: function initialFee() {
						var price = this.calculatorValues[0].initialValue;
				...
				declinationOfYear: function declinationOfYear() {
						var value = parseInt(this.calculatorValues[1].initialValue);
						var spelling = '';
						if (value === 1 || value === 21) {
								spelling = 'Год';
				...
				foo: function foo() {
						var arr = [];
						this.calculatorValues.forEach(function (element, i) {
				...
				perMountly: function perMountly() {
						...
						var creditTerm = this.calculatorValues[1].initialValue * 12;
						var loanRatePerMo = this.calculatorValues[3].initialValue / 12 / 100;
...
$(function () {
		...
		ymaps.ready(function () {
				if ($('#map-ya').length > 0) {
						...
						var generalpoint = new ymaps.Placemark([53.309498, 50.287493], {
								hintContent: '',
						...
						var generalpointqw = new ymaps.Placemark([53.3150317, 50.2947756], {
								hintContent: '',
								balloonContent: 'Мега'
						}, {
								iconLayout: 'default#image',
						...
						var generalpointqe = new ymaps.Placemark([53.306051, 50.278459], {
								hintContent: '',
  ...
  */
		$('.value-change__input_text').on('change', function () {
				...
				for (var i = 0; i < arrayValues.length; i++) {
						var elemInitVal = arrayValues[i].initialValue;
